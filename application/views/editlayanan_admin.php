				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<div class="pull-right" style="margin-right: 15px">
							<a href="<?php echo base_url()."index.php/layanan_admin/"?>" class="btn btn-warning btn-flat" type="button" ><i class="fa fa-undo"></i>Back</a>
						</div>
...
<section class="wrapper">
	 ...
	 <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url()."index.php/layanan_admin/update"?>">
