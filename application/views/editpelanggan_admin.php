				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li><a href=""><i class="menu-icon fa fa-list-alt"></i> Pelanggan</li></a>
              			<li><i class="icon_document_alt"></i>Form Edit Pelanggan</li>
						</ul><!-- /.breadcrumb -->
						...
						<h3 class="page-header">
							<i class="menu-icon fa fa-pencil" style="margin-left: 15px;margin-top: 10px"></i> Edit Pelanggan
						</h3>

						<div class="pull-right" style="margin-right: 15px">
							<a href="<?php echo base_url()."index.php/pelanggan_admin/"?>" class="btn btn-warning btn-flat" type="button" ><i class="fa fa-undo"></i>Back</a>
						</div>
							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="NIK" class="col-xs-10 col-sm-5" value="<?php echo $customer->NIK ?>" required />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="nama" class="col-xs-10 col-sm-5" value="<?php echo $customer->nama ?>" required />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="Email" class="col-xs-10 col-sm-5" value="<?php echo $customer->Email ?>" readonly />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="Password" class="col-xs-10 col-sm-5" value="<?php echo $customer->Password ?>" required />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="NoHp" class="col-xs-10 col-sm-5" value="<?php echo $customer->NoHp ?>" required />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="Alamat" class="col-xs-10 col-sm-5" value="<?php echo $customer->Alamat ?>" required />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="Nama_JenisFile" class="col-xs-10 col-sm-5" value="<?php echo $customer->Nama_JenisFile ?>" readonly />
										</div>
									</div>

								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis Pelanggan * <span class="required"></span></label>
											<div class="col-sm-9">
					 		                	<input type="text" id="Username" name="Jenis_Pelanggan" class="col-xs-10 col-sm-5" value="<?php echo $customer->Jenis_Pelanggan ?>" readonly />
					                        </div>
									</div>
