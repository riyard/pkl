			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
						<li><a href=""><i class="menu-icon fa fa-pencil-square-o"></i> Sales</li></a>
              			<li><i class="icon_document_alt"></i>Tabel Sales</li>
						</ul><!-- /.breadcrumb -->
						...
						<h3 class="page-header">
							<i class="menu-icon fa fa-user" style="margin-left: 15px;margin-top: 10px"></i> Tabel Sales
						</h3>

						<div class="pull-left" style="margin-right: 15px;margin-left: 15px">
							<a href="<?php echo base_url()."index.php/sales_admin/input"?>" class="btn btn-primary btn-sm" type="button"><i class="fa fa-user-plus"></i>Tambah Sales</a>
						</div>
						...
						<table class="table table-striped table-advance table-hover">
					                <tbody>
					                  ...
					                  <?php $nomor=1;foreach ($karyawan_master as $value) {?>
					                    ...
					                    <td>
					                  	<div class="btn-group">
											<a href="<?php echo base_url()."index.php/sales_admin/edit/".$value->id_Karyawan?>" class="btn btn-primary btn-xs">
												<i class="fa fa-pencil"></i> Edit
											</a>
										
											<a href="<?php echo base_url()."index.php/sales_admin/delete/".$value->id_Karyawan?>" class="btn btn-danger btn-xs">
