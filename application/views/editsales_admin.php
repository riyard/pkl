				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li><a href=""><i class="menu-icon fa fa-list-alt"></i> Sales</li></a>
              			<li><i class="icon_document_alt"></i>Form Edit Sales</li>
						</ul><!-- /.breadcrumb -->
						...
						<h3 class="page-header">
							<i class="menu-icon fa fa-pencil" style="margin-left: 15px;margin-top: 10px"></i> Edit Sales
						</h3>

						<div class="pull-right" style="margin-right: 15px">
							<a href="<?php echo base_url()."index.php/sales_admin/"?>" class="btn btn-warning btn-flat" type="button" ><i class="fa fa-undo"></i>Back</a>
						</div>
                  ...
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url()."index.php/sales_admin/update"?>">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Sales * <span class="required"></span></label>
										<div class="col-sm-9">
