				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li><a href=""><i class="menu-icon fa fa-pencil-square-o"></i> Invoice</li></a>
              			<li><i class="icon_document_alt"></i>Tabel Invoice</li>
						</ul><!-- /.breadcrumb -->
						...
						<h3 class="page-header">
							<i class="menu-icon fa fa-barcode" style="margin-left: 15px;margin-top: 10px"></i> Tabel Invoice
						</h3>

						<div class="pull-left" style="margin-right: 15px;margin-left: 15px">
							<a href="<?php echo base_url()."index.php/invover_admin/input"?>" class="btn btn-primary btn-sm" type="button"><i class="fa fa-pencil-square-o"></i>Tambah Invoice</a>
						</div>
						...
						<table id="simple-table" class="table  table-bordered table-hover">
					                <tbody>
					                  <tr>
					                    ...
					                    <th><i class="icon_profile"></i> Detail</th>
					                  ...
					                  <?php $nomor=1;foreach ($invoice as $value) {?>
					                    ...
					                    <td>
					                  	<div class="btn-group">
											<a href="<?php echo base_url()."index.php/invover_admin/edit/".$value->No_Faktur?>" class="btn btn-primary btn-xs">
												<i class="fa fa-pencil"></i> Edit
											</a>
										
											<a href="<?php echo base_url()."index.php/invover_admin/delete/".$value->No_Faktur?>" class="btn btn-danger btn-xs">
