				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li><a href=""><i class="menu-icon fa fa-list-alt"></i> Karyawan</li></a>
              			<li><i class="icon_document_alt"></i>Table Karyawan</li>
						</ul><!-- /.breadcrumb -->
						...
						<h3 class="page-header"><i class="menu-icon fa fa-list-alt" style="margin-left: 10px"></i> Edit Karyawan</h3>
                 ...
                 <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url()."index.php/karyawan_admin/update"?>">
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="Username" name="NIP" type="text" value="<?php echo $karyawan_master->NIP ?>" required />
                      </div>
                    </div>
                       <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Nama Karyawan <span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="Username" name="Nama" type="text" value="<?php echo $karyawan_master->Nama ?>" required />
                      </div>
                         <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Email <span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="Username" name="Email" type="text" value="<?php echo $karyawan_master->Email ?>" required />
                      </div>
                         <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Password <span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="Username" name="Password" type="text" value="<?php echo $karyawan_master->Password ?>" required />
                      </div>
                         <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">No Handphone <span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="Username" name="NoHp" type="text" value="<?php echo $karyawan_master->NoHp ?>" required />
                      </div>
                    </div>
                     <div class="form-group">
                      <label for="cname" class="control-label col-lg-2">Alamat<span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="Username" name="Alamat" type="text" value="<?php echo $karyawan_master->Alamat ?>" required />
                      </div>
                    </div>
