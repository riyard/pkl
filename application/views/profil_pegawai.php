...
<div class="main-content-inner">
	<section class="wrapper">
                 <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url()."index.php/edit_profilpegawai/"?>">
							...
							<div class="col-xs-12">
                    			...
                    			<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="NIP" class="col-xs-10 col-sm-5" value="<?php echo $this->session->userdata('NIP') ?>" readonly />
										</div>
									</div> 
                    			<form class="form-horizontal" role="form">
									<div class="form-group">
