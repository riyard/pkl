				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li><a href=""><i class="menu-icon fa fa-list-alt"></i> Pelanggan</li></a>
              			<li><i class="icon_document_alt"></i>Form Tambah Pelanggan</li>
						</ul><!-- /.breadcrumb -->
						...
						<h3 class="page-header">
							<i class="menu-icon fa fa-user-plus" style="margin-left: 15px;margin-top: 10px"></i> Tambah Pelanggan
						</h3>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis Pelanggan * <span class="required"></span></label>
											<div class="col-sm-9">
					 		                	<select name="Jenis_Pelanggan" class="col-xs-10 col-sm-5" required >  
