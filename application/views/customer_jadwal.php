				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<h3 class="page-header">
							<i class="menu-icon fa fa-list-alt" style="margin-left: 15px;margin-top: 10px"></i> Customer Jadwal</h3>


					<div class="pull-left" style="margin-right: 15px;margin-left: 15px">
					 <a href="<?php echo base_url()."index.php/customer_jadwal/input"?>"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-user-plus"></i>Tambah Jadwal</button></a>
					</div>
