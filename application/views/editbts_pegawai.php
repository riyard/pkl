			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<h3 class="page-header"><i class="menu-icon fa fa-list-alt" style="margin-left: 15px;margin-top: 10px"></i> Edit BTS</h3>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="Koordinat" class="col-xs-10 col-sm-5" value="<?php echo $bts->Koordinat ?>" required />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="KodePelanggan_PLN" class="col-xs-10 col-sm-5" value="<?php echo $bts->KodePelanggan_PLN ?>" required />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="Nama_PIC" class="col-xs-10 col-sm-5" value="<?php echo $bts->Nama_PIC ?>" required />
										</div>
									</div>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Username" name="NoHp_PIC" class="col-xs-10 col-sm-5" value="<?php echo $bts->NoHp_PIC ?>" required />
										</div>
									</div>
