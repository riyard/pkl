				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li><a href=""><i class="menu-icon fa fa-list-alt"></i> Sales</li></a>
              			<li><i class="icon_document_alt"></i>Form Tambah Sales</li>
						</ul><!-- /.breadcrumb -->
						...
						<h3 class="page-header">
							<i class="menu-icon fa fa-user-plus" style="margin-left: 15px;margin-top: 10px"></i> Tambah Sales
						</h3>
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Level * <span class="required"></span></label>
											<div class="col-sm-9">
					 		                	<input type="text" id="Username" name="Level" class="col-xs-10 col-sm-5" value="sales" readonly />
					                        </div>
									</div>
